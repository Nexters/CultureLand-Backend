...
create table dibs (id bigint generated by default as identity,start_date varchar(255), end_date varchar(255), image_url varchar(255), place varchar(255), title varchar(255), culture_id bigint, primary key (id));
