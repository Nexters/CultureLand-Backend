...
create table diary (id bigint auto_increment, content text not null, created_by timestamp, place varchar(255) not null, sometime timestamp not null, title varchar(30) not null, with_who varchar(255) not null, user_seq bigint not null, culture_id bigint not null, primary key (id));
