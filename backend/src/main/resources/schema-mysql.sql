...
CREATE TABLE culture (id bigint auto_increment, culture_name varchar(255), primary key (id), constraint Uniquekey_constraint unique(culture_name));
create table culture_rowdata (id bigint auto_increment, start_date varchar(255), end_date varchar(255), image_url varchar(255), place varchar(255), title varchar(255),
